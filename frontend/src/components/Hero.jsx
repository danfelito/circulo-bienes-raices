...
export default function Hero() {
  return (
    <section className="hero-section relative overflow-visible min-h-screen pt-20">
      <div className="absolute inset-0 z-0">
        <div className="hero-overlay absolute inset-0 z-10" />
        <div className="hero-image w-full h-full bg-[url('https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1920&q=80')] bg-cover bg-center" />
      </div>
      <div className="hero-fade absolute bottom-0 w-full h-[300px] z-0" />
