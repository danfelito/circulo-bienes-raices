...
const AdminLogin = () => {
  ...
  useEffect(() => {
    api.getMe().then(() => navigate('/admin', { replace: true })).catch(() => {});
  }, [navigate]);
    ...
    <main className="pt-20 min-h-screen bg-[#0a0a0a] flex items-center justify-center">
      <div className="w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-xs text-gray-400 mb-1 block" htmlFor="admin-email">Email</label>
          ...
          <div>
            <label className="text-xs text-gray-400 mb-1 block" htmlFor="admin-password">Contraseña</label>
            <div className="relative">
