...
export default function Stats() {
  return (
    <section className="stats-section relative py-32 px-6 lg:px-16 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="stats-image w-full h-full bg-[url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1920&q=80')] bg-cover bg-center" />
